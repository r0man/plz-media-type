...
#+HTML_HEAD: <style> html, body { height: 100%; } </style>
#+HTML_HEAD: <style> html { display: table; margin: auto; } </style>
#+HTML_HEAD: <style> body { color: #4a4a4a; font-family: 'Google Sans', sans-serif; display: table-cell; vertical-align: middle; max-width 1024px; } </style>
